...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asdf-standard-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15570&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asdf-standard-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asdf-standard` can be installed with:

```
conda install asdf-standard
```

It is possible to list all of the versions of `asdf-standard` available on your platform with:
